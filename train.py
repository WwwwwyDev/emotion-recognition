...
if __name__ == '__main__':
    dataset = FaceDataset(csv_path="./expertclass2/train_data.csv", is_test=False)
    # 超参数可自行指定
    train(train_dataset=dataset, batch_size=128, epochs=300, learning_rate=0.0001, wt_decay=0)
